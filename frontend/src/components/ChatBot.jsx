      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`fixed bottom-6 right-6 w-full max-w-sm ${isMinimized ? 'h-auto' : 'h-[500px]'} bg-white dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col z-50 border border-gray-200 dark:border-gray-700 overflow-hidden backdrop-blur-3xl`}
          >
            {/* Header */}
